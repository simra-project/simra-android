...
public class AccEvent {
    ...
    public AccEvent(int key, double lat, double lon, long timeStamp, boolean annotated, String incidentType) {
        Log.d(TAG, "AccEvent " + key + " constructor incidentType: " + incidentType);
        this.key = key;
        this.position = new GeoPoint(lat, lon);
        this.timeStamp = timeStamp;
        this.annotated = annotated;
