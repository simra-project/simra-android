...
import de.tuberlin.mcc.simra.app.util.ConnectionManager.CCCD_UUID
import java.util.Locale
import java.util.UUID

/** UUID of the Client Characteristic Configuration Descriptor (0x2902). */
private const val TAG = "BleExtensions_LOG"
...
fun BluetoothGattDescriptor.isCccd() =
    uuid.toString().uppercase(Locale.ROOT) == CCCD_UUID.toString() .uppercase(Locale.ROOT)