...
public class Constants {
    ...
    public static final String MCC_VM2 = "https://vm3.mcc.tu-berlin.de:8082/";
    ...
    // Locales
    public static final String[] LOCALE_ABVS = {"UNKNOWN", "Berlin", "London", "other", "Bern", "Pforzheim", "Augsburg", "Bochum", "Stuttgart"};
